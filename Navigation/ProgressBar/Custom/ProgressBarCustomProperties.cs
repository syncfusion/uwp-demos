    ...
    public class ProgressBarCustomProperties : NotificationObject
    {
        ...
        private void UpdateTemplate()
        {
            ...
            if(dictionary == null)
            {
                ...
                dictionary.Source = new Uri("ms-appx:///Syncfusion.SampleBrowser.UWP.Navigation/ProgressBar/Custom/ProgressBarCustomTemplates.xaml", UriKind.RelativeOrAbsolute);
            }
