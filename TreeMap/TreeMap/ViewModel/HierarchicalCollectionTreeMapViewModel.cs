...
namespace TreeMapWinRTSamples
{
    ...
    public class CountrySalesCollection : ObservableCollection<CountrySale>, IDisposable
    {
    ...
    public class CountrySale : INotifyPropertyChanged,IDisposable
    {
