...
namespace Syncfusion.SampleBrowser.UWP.SfGantt
{
    ...
    public class SamplesConfiguration
    {
        ...
        public SamplesConfiguration()
        {
            ...
            {
                path = "ms-appx:///Syncfusion.SampleBrowser.UWP.SfGantt/";
            }

            SampleHelper.SampleViews.Add(
                new SampleInfo()
                    {
                        ProductIcons = path + "Images/gantt.png",
            ...
            SampleHelper.SampleViews.Add(
                new SampleInfo()
                {
                    ...
                    Header = "Stripline",
                    SampleCategory = "SfGantt",
                    DesktopImage = path + "Assets/Stripline.jpg",
                    MobileImage = path + "Assets/Stripline.jpg",
                ...
                new SampleInfo()
                    {
                        ...
                        DesktopImage = path + "Assets/ProjectTracker.jpg",
                        MobileImage = path + "Assets/ProjectTracker.jpg",
