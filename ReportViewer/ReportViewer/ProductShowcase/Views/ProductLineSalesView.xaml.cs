...
namespace Syncfusion.SampleBrowser.UWP.ReportViewer
{
    ...
    /// </summary>
    public sealed partial class ProductLineSalesView : SampleLayout, IDisposable
    {
        ...
        public ProductLineSalesView()
        {
            this.InitializeComponent();
            this.SampleView = new ProductLineSales(this.reportViewer);
