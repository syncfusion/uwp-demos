...
namespace Syncfusion.SampleBrowser.UWP.ReportViewer
{
    ...
    /// </summary>
    public sealed partial class ConditionalParameterView : Common.SampleLayout, IDisposable
    {
        ...
        public ConditionalParameterView()
        {
            this.InitializeComponent();
            SampleView = new ConditionalParameter(this.reportViewer);
