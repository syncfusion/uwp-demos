...
namespace Syncfusion.SampleBrowser.UWP.SfKanban
{
    ...
    public class TaskDetails
    {
        ...
        public TaskDetails()
        {
            ...
            {
                path = "ms-appx:///Syncfusion.SampleBrowser.UWP.SfKanban/";
            }
            ...
            task.ImageURL = new Uri(path + "Images/SoftwareDevelopmentProcess/Image0.png");
            Tasks.Add(task);
            ...
            task.ImageURL = new Uri(path + "Images/SoftwareDevelopmentProcess/Image1.png");
            Tasks.Add(task);
            ...
            task.ImageURL = new Uri(path + "Images/SoftwareDevelopmentProcess/Image2.png");
            Tasks.Add(task);
            ...
            task.ColorKey = "High";
            task.Tags = new string[] { "Bug Fixing" };
            task.ImageURL = new Uri(path + "Images/SoftwareDevelopmentProcess/Image3.png");
            Tasks.Add(task);
            ...
            task.ColorKey = "Low";
            task.Tags = new string[] { "Bug Fixing" };
            task.ImageURL = new Uri(path + "Images/SoftwareDevelopmentProcess/Image4.png");
            Tasks.Add(task);
            ...
            task.ImageURL = new Uri(path + "Images/SoftwareDevelopmentProcess/Image5.png");
            Tasks.Add(task);
            ...
            task.ColorKey = "Normal";
            task.Tags = new string[] { "Bug Fixing" };
            task.ImageURL = new Uri(path + "Images/SoftwareDevelopmentProcess/Image7.png");
            Tasks.Add(task);
            ...
            task.ColorKey = "Low";
            task.Tags = new string[] { "New Control" };
            task.ImageURL = new Uri(path + "Images/SoftwareDevelopmentProcess/Image8.png");
            Tasks.Add(task);
        }
