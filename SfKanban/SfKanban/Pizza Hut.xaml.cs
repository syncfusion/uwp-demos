...
namespace Syncfusion.SampleBrowser.UWP.SfKanban
{
    ...
    public class MenuDetails
    {
        ...
        public MenuDetails()
        {
            ...
            item.ImageURL = new Uri(path + "Images/PizzaShop/DoubleCheeseMargherita.png");
            PizzaShop.Add(item);
            ...
            item.Tags = new string[] { "Onions", "Bell Pepper", "Pork", "Cheese" };
            item.ImageURL = new Uri(path + "Images/PizzaShop/Bucolicpie.png");
            PizzaShop.Add(item);
            ...
            item.Tags = new string[] { "Onions", "Bell Pepper", "Pork", "Cheese" };
            item.ImageURL = new Uri(path + "Images/PizzaShop/Bumpercrop.png");
            PizzaShop.Add(item);
            ...
            item.Tags = new string[] { "Onions", "Bell Pepper", "Pork", "Cheese" };
            item.ImageURL = new Uri(path + "Images/PizzaShop/Spiceoflife.png");
            PizzaShop.Add(item);
            ...
            item.Tags = new string[] { "Onions", "Bell Pepper", "Pork", "Cheese" };
            item.ImageURL = new Uri(path + "Images/PizzaShop/Verynicoise.png");
            PizzaShop.Add(item);
            ...
            item.Tags = new string[] { "Onions", "Bell Pepper", "Pork", "Cheese" };
            item.ImageURL = new Uri(path + "Images/PizzaShop/Margherita.png");
            PizzaShop.Add(item);
            ...
            item.Tags = new string[] { "Onions", "Bell Pepper", "Pork", "Cheese" };
            item.ImageURL = new Uri(path + "Images/PizzaShop/Saladdaze.png");
