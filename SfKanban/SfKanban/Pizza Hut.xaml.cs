...
namespace Syncfusion.SampleBrowser.UWP.SfKanban
{
    ...
    public class MenuDetails
    {
        ...
        public MenuDetails()
        {
            ...
            item.ImageURL = new Uri("ms-appx:///Syncfusion.SampleBrowser.UWP.SfKanban/Images/PizzaShop/DoubleCheeseMargherita.png");
            PizzaShop.Add(item);
            ...
            item.Tags = new string[] { "Onions", "Bell Pepper", "Pork", "Cheese" };
            item.ImageURL = new Uri("ms-appx:///Syncfusion.SampleBrowser.UWP.SfKanban/Images/PizzaShop/Bucolicpie.png");
            PizzaShop.Add(item);
            ...
            item.Tags = new string[] { "Onions", "Bell Pepper", "Pork", "Cheese" };
            item.ImageURL = new Uri("ms-appx:///Syncfusion.SampleBrowser.UWP.SfKanban/Images/PizzaShop/Bumpercrop.png");
            PizzaShop.Add(item);
            ...
            item.Tags = new string[] { "Onions", "Bell Pepper", "Pork", "Cheese" };
            item.ImageURL = new Uri("ms-appx:///Syncfusion.SampleBrowser.UWP.SfKanban/Images/PizzaShop/Spiceoflife.png");
            PizzaShop.Add(item);
            ...
            item.Tags = new string[] { "Onions", "Bell Pepper", "Pork", "Cheese" };
            item.ImageURL = new Uri("ms-appx:///Syncfusion.SampleBrowser.UWP.SfKanban/Images/PizzaShop/Verynicoise.png");
            PizzaShop.Add(item);
            ...
            item.Tags = new string[] { "Onions", "Bell Pepper", "Pork", "Cheese" };
            item.ImageURL = new Uri("ms-appx:///Syncfusion.SampleBrowser.UWP.SfKanban/Images/PizzaShop/Margherita.png");
            PizzaShop.Add(item);
            ...
            item.Tags = new string[] { "Onions", "Bell Pepper", "Pork", "Cheese" };
            item.ImageURL = new Uri("ms-appx:///Syncfusion.SampleBrowser.UWP.SfKanban/Images/PizzaShop/Saladdaze.png");
