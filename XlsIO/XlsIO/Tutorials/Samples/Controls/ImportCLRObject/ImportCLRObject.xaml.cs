...
namespace EssentialXlsIO
{
    ...
    /// </summary>
    public sealed partial class ImportCLRObject : SampleLayout
    {
        public ImportCLRObject()
        {
        ...
        private async void btnExportData_Click(object sender, RoutedEventArgs e)
        {
            ...
            sheet.ImportData((List<CLRObject>)this.grdViewExport.ItemsSource, 4, 1, true);
            ...
            else
            {
                ...
                if (workbook.Version == ExcelVersion.Excel97to2003)
                    storageFile = await local.CreateFileAsync("CLRObjects.xls", CreationCollisionOption.ReplaceExisting);
                else
                    storageFile = await local.CreateFileAsync("CLRObjects.xlsx", CreationCollisionOption.ReplaceExisting);
            }
        ...
        private async void btnImportData_Click(object sender, RoutedEventArgs e)
        {
            ...
            List<CLRObject> CLRObjects = worksheet.ExportData<CLRObject>(1, 1, 41, 4);
    ...
    public class ImportAndExport : INotifyPropertyChanged, IDisposable
    {
        ...
        {
            CustomersInfo = new List<CLRObject>();
            foreach (int i in Enumerable.Range(1, 20))
            {
                CustomersInfo.Add(new CLRObject());
            }
        }
        private List<CLRObject> customersInfo = null;
        ...
        ///         #region ItemsSource
        public List<CLRObject> CustomersInfo
        {
