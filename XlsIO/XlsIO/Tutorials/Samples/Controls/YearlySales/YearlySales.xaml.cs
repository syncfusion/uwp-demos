...
namespace EssentialXlsIO
{
    ...
    /// </summary>
    public sealed partial class YearlySales : SampleLayout
    {    
        public YearlySales()
        {
            ...
            this.textBox1.Text = "Please click the 'Generate Excel' button to view the yearly sales Excel document.";
        }
        ...
        private async void btnCreate_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (!(Windows.Foundation.Metadata.ApiInformation.IsTypePresent("Windows.Phone.UI.Input.HardwareButtons")))
            {
                ...
                savePicker.SuggestedFileName = "YearlySales";
            ...
            else
            {
                ...
                storageFile = await local.CreateFileAsync("YearlySales.xlsx", CreationCollisionOption.ReplaceExisting);
            }
            ...
            using (ExcelEngine excelEngine = new ExcelEngine())
            {
                ...
                range.CellStyle.Color = Windows.UI.Color.FromArgb(0, 155, 194, 230);
                ...
                sheet2.Range["A1:E1"].CellStyle.Color = Windows.UI.Color.FromArgb(0, 198, 224, 180);
                sheet2.Range["A1:E1"].CellStyle.Font.Bold = true;
                sheet2.Range["A14:E14"].CellStyle.Color = Windows.UI.Color.FromArgb(0, 198, 224, 180);
        ...
        List<IStyle> CreateStyles(IWorkbook workbook)
        {
            ...
            style1.Color = Windows.UI.Color.FromArgb(0,155, 194, 230);
            style1.Font.Size = 18;
            ...
            style2.Color = Windows.UI.Color.FromArgb(0,244, 176, 132);
            style2.Font.Size = 18;
            ...
            style3.Color = Windows.UI.Color.FromArgb(0, 255, 217, 102);
            style3.Font.Size = 18;
            ...
            style4.Color = Windows.UI.Color.FromArgb(0, 169, 208, 142);
            style4.Font.Size = 18;
            ...
            style5.Color = Windows.UI.Color.FromArgb(0, 155, 194, 230);
            ...
            style6.Color = Windows.UI.Color.FromArgb(0, 244, 176, 132);
            ...
            style7.Color = Windows.UI.Color.FromArgb(0, 255, 217, 102);
            ...
            style8.Color = Windows.UI.Color.FromArgb(0, 169, 208, 142);
