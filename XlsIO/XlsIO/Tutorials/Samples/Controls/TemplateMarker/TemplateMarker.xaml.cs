...
namespace EssentialXlsIO
{
    ...
    public sealed partial class TemplateMarker : SampleLayout
    {
        ...
        public IList<Customers> GetList(Stream fileStream)
        {
            ...
            {
                imageStream = assembly.GetManifestResourceStream("Syncfusion.SampleBrowser.UWP.XlsIO.XlsIO.Tutorials.Samples.Assets.Resources.Templates.Template_Marker_Images." + cust.ImageText);
