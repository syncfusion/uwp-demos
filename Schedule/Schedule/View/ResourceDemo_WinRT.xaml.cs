using Common;
using SampleBrowser;
using SampleBrowser.UWP.Schedule;
   ...
   #region ResourceDemo Class
    ...
    public sealed partial class ResourceDemo_WinRT : SampleLayout, IDisposable
    {
        ...
        public ResourceDemo_WinRT()
        {
            ...
            (this.Schedule1.ScheduleResourceTypeCollection[0].ResourceCollection[0] as CustomResource).ResourceImageUri = isIndividualSample ? new BitmapImage(new Uri("ms-appx:/Schedule/Assets/emp1.png")) : new BitmapImage(new Uri("ms-appx:/Syncfusion.SampleBrowser.UWP.Schedule/Schedule/Assets/emp1.png"));
            (this.Schedule1.ScheduleResourceTypeCollection[0].ResourceCollection[1] as CustomResource).ResourceImageUri = isIndividualSample ? new BitmapImage(new Uri("ms-appx:/Schedule/Assets/emp2.png")) : new BitmapImage(new Uri("ms-appx:/Syncfusion.SampleBrowser.UWP.Schedule/Schedule/Assets/emp2.png"));
