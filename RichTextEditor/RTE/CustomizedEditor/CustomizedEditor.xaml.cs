...
namespace RTEDemo
{
    ...
    public sealed partial class CustomizedEditor : Page, INotifyPropertyChanged, IDisposable
    {
        ...
        #region Property
        public Uri BoldIconUri { get; set; }
        public Uri ItalicIconUri { get; set; }
        public Uri UnderlineIconUri { get; set; }
        public Uri StrikeIconUri { get; set; }
        public Uri IncreaseFontIconUri { get; set; }
        public Uri DecreaseFontIconUri { get; set; }
        public Uri EditIconUri { get; set; }
        public Uri InsertImageIconUri { get; set; }
        public Uri BrushIconUri { get; set; }
        public Uri FindIconUri { get; set; }
        public Uri NavigateRightIconUri { get; set; }
        #endregion
        ...
        #region Toolbar icons Implementation
        /// <summary>
        /// Initializes and assigns all toolbar-related icons and font resources 
        /// </summary>
        private void InitializeToolBarIcons()
        {
            BoldIconUri = new Uri(PathHelper.GetResourcePath("RTE/Assets/Bold_Icon.png"));
            ItalicIconUri = new Uri(PathHelper.GetResourcePath("RTE/Assets/Italic_Icon.png"));
            UnderlineIconUri = new Uri(PathHelper.GetResourcePath("RTE/Assets/Underline_Icon.png"));
            StrikeIconUri = new Uri(PathHelper.GetResourcePath("RTE/Assets/Strike_Icon.png"));
            IncreaseFontIconUri = new Uri(PathHelper.GetResourcePath("RTE/Assets/IncreaseFont_Icon.png"));
            DecreaseFontIconUri = new Uri(PathHelper.GetResourcePath("RTE/Assets/DecreaseFont_Icon.png"));
            EditIconUri = new Uri(PathHelper.GetResourcePath("RTE/Assets/Edit_Icon.png"));
            InsertImageIconUri = new Uri(PathHelper.GetResourcePath("RTE/Assets/InsertImage_Icon.png"));
            BrushIconUri = new Uri(PathHelper.GetResourcePath("RTE/Assets/Brush_Icon.png"));
            FindIconUri = new Uri(PathHelper.GetResourcePath("RTE/Assets/Find_Icon.png"));
            NavigateRightIconUri = new Uri(PathHelper.GetResourcePath("RTE/Assets/NavigateRight_Icon.png"));
        }
        #endregion
        ...
        private void InitSpellChecker()
        {
            ...
            spellchecker.Dictionaries.Add(PathHelper.GetResourcePath("RTE/Assets/en_US.dic"));
