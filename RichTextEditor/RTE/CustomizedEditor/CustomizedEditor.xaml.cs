    ...
    public sealed partial class CustomizedEditor : Page, INotifyPropertyChanged, IDisposable
    {
        ...
        void HardwareButtons_BackPressed(object sender, BackPressedEventArgs e)
        {
            ...
            if (formatGrid.Visibility == Visibility.Visible)
                HideFormatOptions();
            else if (findGrid.Visibility == Visibility.Visible)
                HideFindOptions();
        ...
        void DocumentEditor_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            if (Windows.Foundation.Metadata.ApiInformation.IsTypePresent("Windows.Phone.UI.Input.HardwareButtons"))
            {
                ...
                statusBar.BackgroundColor = Color.FromArgb(0xff, 0x00, 0x71, 0xbc);
        ...
        {
            if (spacingsFormatGrid.LeftIndentBox.Value != null && (double)spacingsFormatGrid.LeftIndentBox.Value != richTextBox.Selection.ParagraphFormat.LeftIndent)
                richTextBox.Selection.ParagraphFormat.LeftIndent = (double)spacingsFormatGrid.LeftIndentBox.Value;
            if (spacingsFormatGrid.RightIndentBox.Value != null && (double)spacingsFormatGrid.RightIndentBox.Value != richTextBox.Selection.ParagraphFormat.RightIndent)
                richTextBox.Selection.ParagraphFormat.RightIndent = (double)spacingsFormatGrid.RightIndentBox.Value;
            if (spacingsFormatGrid.FirstlineIndentBox.Value != null && (double)spacingsFormatGrid.FirstlineIndentBox.Value != richTextBox.Selection.ParagraphFormat.FirstLineIndent)
                richTextBox.Selection.ParagraphFormat.FirstLineIndent = (double)spacingsFormatGrid.FirstlineIndentBox.Value;
            if (spacingsFormatGrid.BeforeSpacingBox.Value != null && (double)spacingsFormatGrid.BeforeSpacingBox.Value != richTextBox.Selection.ParagraphFormat.BeforeSpacing)
                richTextBox.Selection.ParagraphFormat.BeforeSpacing = (double)spacingsFormatGrid.BeforeSpacingBox.Value;
            if (spacingsFormatGrid.AfterSpacingBox.Value != null && (double)spacingsFormatGrid.AfterSpacingBox.Value != richTextBox.Selection.ParagraphFormat.AfterSpacing)
                richTextBox.Selection.ParagraphFormat.AfterSpacing = (double)spacingsFormatGrid.AfterSpacingBox.Value;
            if (spacingsFormatGrid.LineSpacingBox.Value != null && (double)spacingsFormatGrid.LineSpacingBox.Value != richTextBox.Selection.ParagraphFormat.LineSpacing)
        ...
        private void InitClipBoardOptionsGrid()
        {
            ...
            clipboardOptionsGrid.CopyButton.Style = (Style)this.Resources["RTECopyStyle"];
            clipboardOptionsGrid.CutButton.Style = (Style)this.Resources["RTECutStyle"];
            clipboardOptionsGrid.PasteButton.Style = (Style)this.Resources["RTEPasteStyle"];
