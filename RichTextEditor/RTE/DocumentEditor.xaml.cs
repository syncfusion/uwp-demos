...
namespace RTEDemo
{
    ...
    public sealed partial class DocumentEditor : Page, IDisposable
    {
        ...
        public DocumentEditor()
        {
            ...
            this.richTextBox.SpellChecker.Dictionaries.Add(PathHelper.GetResourcePath("RTE/Assets/en_US.dic"));
        ...
        /// <summary>
        /// Initializes and assigns all ribbon-related icons and font resources 
        /// </summary>
        private void InitializeRibbonIcons()
        {
            //Home Tab
            cutCommand.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/Home/Cut.png")));
            copyButton.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/Home/Copy.png")));
            pasteButton.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/Home/Paste.png")));
            boldButton.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/Home/Bold.png")));
            italicButton.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/Home/Italic.png")));
            underlineButton.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/Home/Underline.png")));
            fontColorDropDownButton.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/Home/FontColor.png")));
            highlightColorDropDownButton.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/Home/HighlightColor.png")));
            leftAlignButton.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/Home/Left.png")));
            centerAlignButton.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/Home/Center.png")));
            rightAlignButton.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/Home/Right.png")));
            justifyAlignButton.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/Home/Justify.png")));
            bulletButton.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/Home/Bullet.png")));
            numeringButton.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/Home/Numbering.png")));
            leftToRight.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/Home/LeftToRight.png")));
            rightToLeft.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/Home/RightToLeft.png")));
            findButton.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/Home/Find.png")));
            replaceButton.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/Home/Replace.png")));

            //Insert Tab
            insertBreakbutton.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/Insert/PageBreak.png")));
            tabledropdown.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/Insert/InsertTable.png")));
            insertPicturebutton.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/Insert/InsertPicture.png")));
            hyperlinkbutton.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/Insert/Hyperlink.png")));

            //View Tab
            pageviewButton.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/View/PrintMode.png")));
            webviewButton.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/View/WebMode.png")));
            zoom100Button.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/View/Zoom100.png")));
            onepageButton.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/View/OnePage.png")));
            pagewidthButton.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/View/PageWidth.png")));

            //Review Tab
            spellcheckerButton.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/Review/SpellChecker.png")));
            newcommentButton.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/Review/NewComment.png")));
            deletecommentButton.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/Review/DeleteComment.png")));
            previouscommentButton.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/Review/PreviousComment.png")));
            nextcommentButton.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/Review/NextComment.png")));
            showcommentsButton.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/Review/ShowComments.png")));

            //Table Layout Tab
            autofitContentButton.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/Table/AutoFitContents.png")));
            autofitWindowButton.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/Table/AutoFitWindow.png")));
            autofitTableButton.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/Table/FixedColumnWidth.png")));

            //Backstage
            newBackStageTabItem.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/Backstage/New.png")));
            blank.Source = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/Templates/Blank.png")));
            takeATourImage.Source = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/Templates/TakeATour.png")));
            letterImage.Source = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/Templates/Letter.png")));
            titleImage.Source = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/Templates/Title.png")));
            faxImage.Source = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/Templates/Fax.png")));
            toDoListImage.Source = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/Templates/ToDoList.png")));
            openBackStageButton.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/Backstage/Open.png")));
            saveAsBackStageButton.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/Backstage/SaveAs.png")));
            printBackStageButton.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/Backstage/print.png")));
            helpBackaStageButton.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/Backstage/Help.png")));
            exitBackStageButton.Icon = new BitmapImage(new Uri(PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/Backstage/Exit.png")));

            //Quick access toolbar
            var fontPath = PathHelper.GetResourcePath("RTE/Assets/RibbonIcons/RibbonQATIcons.ttf#RibbonQATIcons");
            newAQTIcon.FontIconFontFamily = new FontFamily(fontPath);
            undoQATIcon.FontIconFontFamily = new FontFamily(fontPath);
            redoQATIcon.FontIconFontFamily = new FontFamily(fontPath);
        }
        #endregion
