...
namespace RTEDemo
{
    public sealed partial class ForumReplyControl : UserControl
    {
        ...
        public ForumReplyControl(Page parentPage)
        {
            ...
            BitmapImage bitmapImage = new BitmapImage(new Uri("ms-appx:///Syncfusion.SampleBrowser.UWP.RichTextEditor/RTE/Assets/People_Circle0.png"));
            ...
            bitmapImage = new BitmapImage(new Uri("ms-appx:///Syncfusion.SampleBrowser.UWP.RichTextEditor/RTE/Assets/People_Circle14.png"));
            suggestionItem.ImageSource = bitmapImage;
            suggestionItems.Add(suggestionItem);
            ...
            bitmapImage = new BitmapImage(new Uri("ms-appx:///Syncfusion.SampleBrowser.UWP.RichTextEditor/RTE/Assets/People_Circle18.png"));
            suggestionItem.ImageSource = bitmapImage;
            suggestionItems.Add(suggestionItem);
            ...
            bitmapImage = new BitmapImage(new Uri("ms-appx:///Syncfusion.SampleBrowser.UWP.RichTextEditor/RTE/Assets/People_Circle2.png"));
            suggestionItem.ImageSource = bitmapImage;
            suggestionItems.Add(suggestionItem);
            ...
            bitmapImage = new BitmapImage(new Uri("ms-appx:///Syncfusion.SampleBrowser.UWP.RichTextEditor/RTE/Assets/People_Circle5.png"));
            suggestionItem.ImageSource = bitmapImage;
            suggestionItems.Add(suggestionItem);
