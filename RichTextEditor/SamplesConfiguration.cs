        ...
        public SamplesConfiguration()
        {
            if (ApiInformation.IsTypePresent("Windows.Phone.UI.Input.HardwareButtons"))
            {
                SampleHelper.SampleViews.Add(new SampleInfo()
                {
                    ...
                    DesktopImage = PathHelper.GetResourcePath("RTE/Assets/Showcase/DocumentEditor_Desktop.jpg"),
                    MobileImage = PathHelper.GetResourcePath("RTE/Assets/Showcase/DocumentEditor_Phone.jpg"),
