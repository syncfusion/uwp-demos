        ...
        public SamplesConfiguration()
        {
            if (ApiInformation.IsTypePresent("Windows.Phone.UI.Input.HardwareButtons"))
            {
                SampleHelper.SampleViews.Add(new SampleInfo()
                {
                    ...
                    DesktopImage = "ms-appx:///Syncfusion.SampleBrowser.UWP.RichTextEditor/RTE/Assets/Showcase/DocumentEditor_Desktop.jpg",
                    MobileImage = "ms-appx:///Syncfusion.SampleBrowser.UWP.RichTextEditor/RTE/Assets/Showcase/DocumentEditor_Phone.jpg",
