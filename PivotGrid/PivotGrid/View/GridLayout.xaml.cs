...
namespace BI.PivotGrid
{
    ...
    public sealed partial class GridLayout : SampleLayout
    {
        ...
        /// <summary>
        /// Initializes the new instance of <see cref="GridLayout">GridLayout.</see>/>
        /// </summary>
        public GridLayout()
        {
        ...
        {
            string selectedLayout = ((sender as ComboBox).SelectedItem as ComboBoxItem).Content.ToString();
            if (selectedLayout == "Normal")
                this.pivotGrid.Layout = Syncfusion.Olap.UWP.Engine.GridLayout.Normal;
            else if (selectedLayout == "ExcelLikeLayout")
                this.pivotGrid.Layout = Syncfusion.Olap.UWP.Engine.GridLayout.ExcelLikeLayout;
            else if (selectedLayout == "NormalTopSummary")
                this.pivotGrid.Layout = Syncfusion.Olap.UWP.Engine.GridLayout.NormalTopSummary;
            else if (selectedLayout == "NoSummaries")
                this.pivotGrid.Layout = Syncfusion.Olap.UWP.Engine.GridLayout.NoSummaries;
        }
