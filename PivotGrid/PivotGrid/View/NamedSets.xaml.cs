...
namespace BI.PivotGrid
{
    ...
    public sealed partial class NamedSets : SampleLayout
    {
        ...
        /// <summary>
        /// Initializes the new instance of <see cref="NamedSets">NamedSets.</see>/>
        /// </summary>
        public NamedSets()
        {
        ...
        private void SetDataManager()
        {
            ...
            olapDataManager.GetCubeSchema += OlapDataManager_GetCubeSchema;
            olapDataManager.GetCubeInfoCollection += OlapDataManager_GetCubeInfoCollection;
            olapDataManager.SetCurrentReport(NamedSetReport());
