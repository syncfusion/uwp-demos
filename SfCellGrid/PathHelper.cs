...
namespace Syncfusion.SampleBrowser.UWP.SfCellGrid
{
    ...
    public static class PathHelper
    {
        ...
        /// </summary>
        /// <param name="relativePath">Relative resource path (e.g., "Images\Bangladesh.jpg")</param>
        ...
        public static string GetResourcePath(string relativePath)
        {
            ...
            if (assemblyName == "Syncfusion.SampleBrowser.UWP")
            {
                ...
                return $"ms-appx:///Syncfusion.SampleBrowser.UWP.SfCellGrid/Assets/{relativePath}";
            }
            else
            {
                // Running in separate assembly - use standard path format
                return $"ms-appx:///Assets/{relativePath}";
            }
        }
    }
}