    ...
    public sealed partial class CellTypes : SampleLayout, IDisposable
    {
        ...
        private List<MovieInfo> GetMovieDetails()
        {
            ...
            model.Add(new MovieInfo()
            {
                ...
                Poster = PathHelper.GetResourcePath("Images/Avatar.jpeg")
            });
            ...
            model.Add(new MovieInfo()
            {
                ...
                City = "New York",
                IsTicketAvailable = true,
                Poster = PathHelper.GetResourcePath("Images/Iceage3.jpeg")
            });
            ...
            model.Add(new MovieInfo()
            {
                ...
                City = "New Jersy",
                IsTicketAvailable = true,
                Poster = PathHelper.GetResourcePath("Images/shrek.jpeg")
            });
            return model;
        }
        ...
        private void Grid_DataTemplateCellType()
        {
            ...
            {
                cellGrid.Model[rowIndex, colIndex].CellType = "DataTemplate";
                cellGrid.Model[rowIndex, colIndex].CellItemTemplateKey = "ImageTemplate";
                cellGrid.Model[rowIndex, colIndex].CellValue = movie.Poster;
                colIndex += 2;
            }
        }
