...
namespace EssentialPdf
{
    ...
    public sealed partial class Barcode : UserControl
    {        
        public Barcode()
        {
        ...
        private async void Button_Click_1(object sender, RoutedEventArgs e)
        {
            ...
            Stream imageStream = typeof(Conformance).GetTypeInfo().Assembly.GetManifestResourceStream("Syncfusion.SampleBrowser.UWP.Pdf.Pdf.Assets.qrcodelogo.png");            
