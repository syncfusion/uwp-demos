...
namespace EssentialPdf
{
    ...
    {        
        ...
        private async void Button_Click_1(object sender, RoutedEventArgs e)
        {
            ...
            //Create font
            Stream arialFontStream = typeof(RTLSupport).GetTypeInfo().Assembly.GetManifestResourceStream("Syncfusion.SampleBrowser.UWP.Pdf.Pdf.Assets.NotoNaskhArabic-Regular.ttf");
            PdfFont font = new PdfTrueTypeFont(arialFontStream, 13);
            ...
            Stream hebrewFontStream = typeof(RTLSupport).GetTypeInfo().Assembly.GetManifestResourceStream("Syncfusion.SampleBrowser.UWP.Pdf.Pdf.Assets.NotoSansHebrew-Medium.ttf");
            PdfFont hebrewFont = new PdfTrueTypeFont(hebrewFontStream, 13);

            Stream rtlText1 = typeof(RTLSupport).GetTypeInfo().Assembly.GetManifestResourceStream("Syncfusion.SampleBrowser.UWP.Pdf.Pdf.Assets.hebrew.txt");
            StreamReader reader1 = new StreamReader(rtlText1, System.Text.Encoding.Unicode);
            ...
            page.Graphics.DrawString(text1, hebrewFont, brush, rect1, format);
