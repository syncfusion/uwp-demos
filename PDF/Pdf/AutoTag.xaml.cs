...
namespace EssentialPdf
{
    ...
    public sealed partial class AutoTag : UserControl
    {
        ...
        private async void GeneratePDF_Click(object sender, RoutedEventArgs e)
        {
            ...
            Stream fontStream = typeof(Conformance).GetTypeInfo().Assembly.GetManifestResourceStream("Syncfusion.SampleBrowser.UWP.Pdf.Pdf.Assets.NotoSans-Regular.ttf");
            PdfFont fontnormal = new PdfTrueTypeFont(fontStream, 9);
            PdfFont fontTitle = new PdfTrueTypeFont(fontStream, 20, PdfFontStyle.Bold);
