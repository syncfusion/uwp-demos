...
namespace DataGrid
{
    ...
    public sealed partial class UnBoundRow : SampleLayout
    {
        ...
        {            
            ...
            {
                if (this.SfDataGrid.SelectedItems == null)
                    this.SfDataGrid.SelectedItems = new System.Collections.ObjectModel.ObservableCollection<object>();
        ...
        double GetSummaryValue(string column, bool totalSummary = true)
        {
            ...
            if (this.SfDataGrid.SelectedItems != null && this.SfDataGrid.SelectedItems.Count != 0 && !totalSummary)
            {
