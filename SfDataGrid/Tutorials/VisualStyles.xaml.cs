...
namespace DataGrid
{
    public sealed partial class VisualStyles : SampleLayout
    {
        ...
        private void StylesComboBox_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            {
                if (resdict.Source.AbsoluteUri.Contains(PathHelper.GetResourcePath("Tutorials/Styles")))
                    return true;
                return false;
            });
            ...
            {
                Source = new Uri(PathHelper.GetResourcePath("Tutorials/Styles/" + comboBox.SelectedItem + ".xaml"), UriKind.Absolute)
            });
        }
