...
namespace DataGrid
{
    ...
    public sealed partial class PdfExporting : SampleLayout
    {
        ...
        async void PdfHeaderFooterEventHandler(object sender, PdfHeaderFooterEventArgs e)
        {
            ...
            var uri = new Uri(PathHelper.GetResourcePath("Tutorials/Assets/Header.jpg"), UriKind.RelativeOrAbsolute);
            ...
            uri = new Uri(PathHelper.GetResourcePath("Tutorials/Assets/Footer.jpg"), UriKind.RelativeOrAbsolute);
