    ...
    class SamplesConfiguration
    {
        public SamplesConfiguration()
        {
            ...
            SampleHelper.SampleViews.Add(new SampleInfo()
            {
                ...
                DesktopImage = PathHelper.GetResourcePath("WhatsNewImages/Expense-Analysis.jpg"),
                MobileImage = PathHelper.GetResourcePath("WhatsNewImages/Expense-Analysis.jpg"),
            ...
            SampleHelper.SampleViews.Add(new SampleInfo()
            {
                ...
                SampleCategory = "Editing",
                DesktopImage = PathHelper.GetResourcePath("WhatsNewImages/ComboBoxColumn.png"),
                MobileImage = PathHelper.GetResourcePath("WhatsNewImages/ComboBoxColumn.png"),
            ...
            SampleHelper.SampleViews.Add(new SampleInfo()
            {
                ...
                Category = Categories.Grids,
                DesktopImage = PathHelper.GetResourcePath("WhatsNewImages/RealTimeUpdate.png"),
                MobileImage = PathHelper.GetResourcePath("WhatsNewImages/RealTimeUpdate.png"),
            ...
            //         Category = Categories.Grids,
            //         DesktopImage = PathHelper.GetResourcePath("WhatsNewImages/VisualStyles.png"),
            //         MobileImage = PathHelper.GetResourcePath("WhatsNewImages/VisualStyles.png"),
            ...
            SampleHelper.SampleViews.Add(new SampleInfo()
            {
                ...
                Category = Categories.Grids,
                DesktopImage = PathHelper.GetResourcePath("WhatsNewImages/CellStyle.png"),
                MobileImage = PathHelper.GetResourcePath("WhatsNewImages/CellStyle.png"),
            ...
            SampleHelper.SampleViews.Add(new SampleInfo()
            {
                ...
                Category = Categories.Grids,
                DesktopImage = PathHelper.GetResourcePath("WhatsNewImages/ContextMenu.png"),
                MobileImage = PathHelper.GetResourcePath("WhatsNewImages/ContextMenu.png"),
            ...
            if (DeviceFamily.GetDeviceFamily() == Devices.Desktop)
            {
                SampleHelper.SampleViews.Add(new SampleInfo()
                {
                    ...
                    Category = Categories.Grids,
                    DesktopImage = PathHelper.GetResourcePath("WhatsNewImages/ColumnChosser.png"),
                    MobileImage = PathHelper.GetResourcePath("WhatsNewImages/ColumnChosser.png"),
                ...
                SampleHelper.SampleViews.Add(new SampleInfo()
                {
                    ...
                    Category = Categories.Grids,
                    DesktopImage = PathHelper.GetResourcePath("WhatsNewImages/RowDragandDrop.png"),
                    MobileImage = PathHelper.GetResourcePath("WhatsNewImages/RowDragandDrop.png"),
