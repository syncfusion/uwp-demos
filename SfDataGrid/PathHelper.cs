...
namespace Syncfusion.SampleBrowser.UWP.SfDataGrid
{
    ...
    public static class PathHelper
    {
        ...
        /// </summary>
        /// <param name="relativePath">Relative resource path (e.g., "WhatsNewImages/Expense-Analysis.jpg")</param>
        ...
        public static string GetResourcePath(string relativePath)
        {
            ...
            if (assemblyName == "Syncfusion.SampleBrowser.UWP")
            {
                ...
                return $"ms-appx:///Syncfusion.SampleBrowser.UWP.SfDataGrid/{relativePath}";
            }
            else
            {
