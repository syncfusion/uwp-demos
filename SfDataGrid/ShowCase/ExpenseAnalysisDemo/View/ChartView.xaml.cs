...
namespace ExpenseAnalysisDemo
{
    ...
    {
        private string backButtonIconPath;

        public string BackButtonIconPath
        {
            get
            {
                if (string.IsNullOrEmpty(backButtonIconPath))
                    backButtonIconPath = PathHelper.GetResourcePath("Assets/icon.png");
                return backButtonIconPath;
            }
        }
