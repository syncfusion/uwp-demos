...
namespace ExpenseAnalysisDemo
{
    public class ViewModel : NotificationObject, IDisposable
    {
        ...
        private string _exportIconPath;
        public string ExportIconPath
        {
            get
            {
                if (string.IsNullOrEmpty(_exportIconPath))
                    _exportIconPath = PathHelper.GetResourcePath("ShowCase/ExpenseAnalysisDemo/Assets/export2.png");
                return _exportIconPath;
            }
        }
