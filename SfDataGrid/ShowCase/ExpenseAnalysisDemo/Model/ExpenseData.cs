...
namespace ExpenseAnalysisDemo
{
    public class ExpenseData
    {
        ...
        public ObservableCollection<ExpenseData> GenerateExpenseData(DateTime start, DateTime end, int recordCount)
        {
            var expenses = new ObservableCollection<ExpenseData>();
            ...
            while (start < end)
            {
                ...
                while (count < recordCount)
                {
                    ...
                    var expense = new ExpenseData
                    {
                        ...
                        Amount = (new Random(catCount).Next(category.Start, category.End)),
        ...
        public bool CheckDataExists(ObservableCollection<ExpenseData> expenses, string category, string subCategory, AccountType type, int incomeMonth)
        {
        ...
        public bool CheckNegativeDataExists(ObservableCollection<ExpenseData> expenses, string category, string subCategory, AccountType type)
        {

            return expenses.Any(expense => expense.CategoryName == category && expense.SubCategory == subCategory);
        }
        public bool CheckIncome(ObservableCollection<ExpenseData> expenses, string category)
        {
