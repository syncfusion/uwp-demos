...
namespace Syncfusion.SampleBrowser.UWP.PivotClient
{
    public class SamplesConfiguration
    {
        ...
        {
            SampleHelper.SetTagsForProduct("PivotClient", Tags.None);
            ...
            SampleHelper.SampleViews.Add(new SampleInfo()
            {
                ...
                Product = "PivotClient",
                HasOptions = false,
                DesktopImage = PathHelper.GetResourcePath("WhatsNewImage/Relational.PNG"),
            ...
            if (AnalyticsInfo.VersionInfo.DeviceFamily != "Windows.Mobile")
            {
                ...
                SampleHelper.SampleViews.Add(new SampleInfo()
                {
                    ...
                    DesktopImage = PathHelper.GetResourcePath("WhatsNewImage/AutoExecute.png"),
                    MobileImage = PathHelper.GetResourcePath("WhatsNewImage/AutoExecute.png")
                });
                ...
                SampleHelper.SampleViews.Add(new SampleInfo()
                {
                    ...
                    DesktopImage = PathHelper.GetResourcePath("WhatsNewImage/AdvancedFiltering.png"),
                });
