    ...
    public class SamplesConfiguration
    {
        public SamplesConfiguration()
        {
            ...
            SampleHelper.SampleViews.Add(new SampleInfo()
            {
                ...
                DesktopImage = "ms-appx:///Syncfusion.SampleBrowser.UWP.Editors/WhatsNewImage/2.png",
                MobileImage = "ms-appx:///Syncfusion.SampleBrowser.UWP.Editors/WhatsNewImage/2.png",
                SearchKeys = new string[] { "DateTime", "Editor", "started", "Picker" }
            });
            ...
            SampleHelper.SampleViews.Add(new SampleInfo()
            {
                ...
                ProductIcons = "Icons/Date Time Pickers.png",
                Category = Categories.Editors,
                DesktopImage = "ms-appx:///Syncfusion.SampleBrowser.UWP.Editors/WhatsNewImage/1.png",
                MobileImage = "ms-appx:///Syncfusion.SampleBrowser.UWP.Editors/WhatsNewImage/1.png",
...
#region Showcase
            SampleHelper.SampleViews.Add(new SampleInfo()
            {
                ...
                Category = Categories.Editors,
                DesktopImage = "ms-appx:///Syncfusion.SampleBrowser.UWP.Editors/Showcase/unit.jpg",
                MobileImage = "ms-appx:///Syncfusion.SampleBrowser.UWP.Editors/Showcase/unit.jpg",
                SearchKeys = new string[] { "DateTime", "Editor", "started", "Picker" }
            });
#endregion
...
#region Ediotrs Sample
            ...
            SampleHelper.SampleViews.Add(new SampleInfo()
            {
                ...
                SearchKeys = new string[] { "Picker", "started", "Getting", "SfPicker" },
                  DesktopImage = "ms-appx:///Syncfusion.SampleBrowser.UWP.Editors/WhatsNewImage/getting.png",
                MobileImage = "ms-appx:///Syncfusion.SampleBrowser.UWP.Editors/WhatsNewImage/getting-mobile.png",
            });
            ...
            SampleHelper.SampleViews.Add(new SampleInfo()
            {
                ...
                SearchKeys = new string[] { "Picker", "Popup", "Popuppicker", "SfPicker" },
                  DesktopImage = "ms-appx:///Syncfusion.SampleBrowser.UWP.Editors/WhatsNewImage/popup.png",
                MobileImage = "ms-appx:///Syncfusion.SampleBrowser.UWP.Editors/WhatsNewImage/popup-mobile.png",
            });

            SampleHelper.SetTagsForProduct("MaskedEdit", Tags.None);
        }
    }
}
