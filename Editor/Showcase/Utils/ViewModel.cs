...
namespace UnitConverter
{
    public class ViewModel : INotifyPropertyChanged
    {
        ...
        private string unitConverterImagePath;
        public string UnitConverterImagePath 
        {
            get
            {
                if (string.IsNullOrEmpty(unitConverterImagePath))
                    unitConverterImagePath = ResourcePathHelper.GetResourcePath("Showcase/unitconverter.png");
                return unitConverterImagePath;
            }
        }
