...
namespace Syncfusion.SampleBrowser.UWP.ImageEditor
{
    ...
    public sealed partial class CustomView : Page
    {
        ...
        public CustomView()
        {
            ...
            {
                new CustomToolbarItem(){Icon=new BitmapImage(new Uri(path + "Image/View/Assets/ITypogy1.png")),CustomName = "ITypogy1",IconHeight=70 },
                new CustomToolbarItem(){Icon=new BitmapImage(new Uri(path + "Image/View/Assets/ITypogy2.png")),CustomName = "ITypogy2",IconHeight=70 },
                new CustomToolbarItem(){Icon=new BitmapImage(new Uri(path + "Image/View/Assets/ITypogy3.png")),CustomName = "ITypogy3",IconHeight=70 },
                new CustomToolbarItem(){Icon=new BitmapImage(new Uri(path + "Image/View/Assets/ITypogy4.png")),CustomName = "ITypogy4",IconHeight=70 },
            };

            var item = new FooterToolbarItem()
            {
                Text = "Add",
                Icon = new BitmapImage(new Uri(path + "Image/View/Assets/AddIcon.png")),
            ...
            {
                Text = "Replace",
                Icon = new BitmapImage(new Uri(path + "Image/View/Assets/ReplaceIcon.png")),
                SubItems = CustomViewItems,
                TextHeight = 20
            };
            editor.ToolbarSettings.ToolbarItems.Add(item);
            ...
            item = new FooterToolbarItem()
            {
                Icon = new BitmapImage(new Uri(path + "Image/View/Assets/BringFrontIcon.png")),
                Text = "Front",
                TextHeight = 20
            };
            editor.ToolbarSettings.ToolbarItems.Add(item);
            ...
            item = new FooterToolbarItem()
            {
                Icon = new BitmapImage(new Uri(path + "Image/View/Assets/SendBack.png")),
                Text = "Back",
                TextHeight = 20
            };
            editor.ToolbarSettings.ToolbarItems.Add(item);
