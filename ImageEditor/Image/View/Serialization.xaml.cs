...
namespace Syncfusion.SampleBrowser.UWP.ImageEditor
{
    ...
    public sealed partial class Serialization : Page
    {
        ...
        public Serialization()
        {
            ...
            deleteImage.Source = new BitmapImage(new Uri(path + "Image/View/Assets/Delete1.png"));
        ...
        private async void ImageEditor_ImageSaving(object sender, ImageSavingEventArgs args)
        {
            ...
            if (SelectedItem.ImageName == "Create New")
            {
                model.ModelList.Add(new SerializationModel
                {
                    ...
                    SelectionImage = new BitmapImage(new Uri(path + "Image/View/Assets/NotSelected.png")),
        ...
        async void LoadingImage(int i, Stream stream)
        {
            ...
            model.ModelList[0].Image = new BitmapImage(new Uri(path + "Image/View/Assets/CreateNew.png"));
        }
        ...
        private void listView1_RightTapped(object sender, RightTappedRoutedEventArgs e)
        {
            ...
            for (int i = 0; i < model.ModelList.Count; i++)
            {
                ...
                model.ModelList[i].SelectionImage = new BitmapImage(new Uri(path + "Image/View/Assets/NotSelected.png"));
        ...
        private void ListView1_SelectionChanged1(object sender, SelectionChangedEventArgs e)
        {
            ...
            for (int i = 0; i < e.AddedItems.Count; i++)
            {
                ...
                {
                    (item as SerializationModel).SelectionImage = new BitmapImage(new Uri(path + "Image/View/Assets/Selected.png"));
            ...
            for (int i = 0; i < e.RemovedItems.Count; i++)
            {
                ...
                (item as SerializationModel).SelectionImage = new BitmapImage(new Uri(path + "Image/View/Assets/NotSelected.png"));
