        ...
        public SamplesConfiguration()
        {
            ...
            if (DeviceFamily.GetDeviceFamily() == Devices.Desktop)
            {
                SampleHelper.SampleViews.Add(new SampleInfo()
                {
                    ...
                    DesktopImage = "ms-appx:///Syncfusion.SampleBrowser.UWP.Diagram/ShowcaseImage/Diagrambuilder.jpg",
                    Description =
            ...
            if (DeviceFamily.GetDeviceFamily() == Devices.Desktop)
            {
                SampleHelper.SampleViews.Add(new SampleInfo()
                {
                    ...
                    Category = Categories.DataVisualization,
                    SampleType = SampleType.Showcase,
                    DesktopImage = "ms-appx:///Syncfusion.SampleBrowser.UWP.Diagram/ShowcaseImage/FloorPlanner.jpg",
                ...
                SampleHelper.SampleViews.Add(new SampleInfo()
                {
                    ...
                    Category = Categories.DataVisualization,
                    SampleType = SampleType.Showcase,
                    DesktopImage = "ms-appx:///Syncfusion.SampleBrowser.UWP.Diagram/ShowcaseImage/WorkFlowEditor.jpg",
                    Description =
            ...
            //    Category = Categories.DataVisualization,
            //    SampleType = SampleType.Showcase,
            //    DesktopImage = "ms-appx:///Syncfusion.SampleBrowser.UWP.Diagram/ShowcaseImage/OrganizationalChart.jpg",
            //    Description =
            ...
            //    Category = Categories.DataVisualization,
            //    SampleType = SampleType.Showcase,
            //    DesktopImage = "ms-appx:///Syncfusion.SampleBrowser.UWP.Diagram/ShowcaseImage/MindMap.jpg",
            ...
            //    Category = Categories.DataVisualization,
            //    SampleType = SampleType.Showcase,
            //    DesktopImage = "ms-appx:///Syncfusion.SampleBrowser.UWP.Diagram/ShowcaseImage/uml.jpg",
            ...
            if (DeviceFamily.GetDeviceFamily() == Devices.Desktop || DeviceFamily.GetDeviceFamily()==Devices.Mobile)
            {
                SampleHelper.SampleViews.Add(new SampleInfo()
                {
                    ...
                    Header = "Flow Diagram",
                    Product = "Diagram",
                    ProductIcons = "ms-appx:///Syncfusion.SampleBrowser.UWP.Diagram/Assets/diagram.png",
