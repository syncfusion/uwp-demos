...
namespace Diagram
{
    ...
    /// </summary>
    public sealed partial class RulerandUnit_WP : UserControl
    {
        private EasClientDeviceInformation deviceinfo;
        public RulerandUnit_WP()
        {
        ...
        public void createNodes()
        {
                ...
                Node NewIdea = addNode("NewIdea", 150, 60, 100, 70, Shapes.FlowChart_Start, "New idea identified", 1,
                    "#65c7d0");
                Node Meeting = addNode("Meeting", 150, 60, 100, 155, Shapes.Rectangle, "Meeting with board", 2,
                    "#65c7d0");
                Node BoardDecision = addNode("BoardDecision", 150, 100, 100, 260, Shapes.FlowChart_Decision,
                ...
                Node End = addNode("End", 100, 60, 100, 515, Shapes.Rectangle, "Implement and Deliver", 4, "#65c7d0");
                Node Decision = addNode("Decision", 180, 60, 360, 60, Shapes.FlowChart_Card,
                    "Decision process for new software ideas", 5, "#858585");
                Node Reject = addNode("Reject", 130, 60, 320, 260, Shapes.Rectangle, "Reject and write report", 4,
                    "#65c7d0");
