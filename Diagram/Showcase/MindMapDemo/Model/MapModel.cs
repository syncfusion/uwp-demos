...
namespace MindMapDemo
{
    public class CustomNode : NodeViewModel
    {
        public CustomNode()
        {
            ...
            {
                Source = new Uri("ms-appx:///Syncfusion.SampleBrowser.UWP.Diagram/Template/ProcessNodeEditorTemplate.xaml", UriKind.RelativeOrAbsolute)
            };
            ContentTemplate = resourceDictionary["CNodeTemplate"] as DataTemplate;
    ...
    public class CustomConnector : Connector
    {
        public CustomConnector()
        {
            ...
            var resourceDictionary = new ResourceDictionary()
            {
                Source = new Uri("ms-appx:///Syncfusion.SampleBrowser.UWP.Diagram/Template/ProcessNodeEditorTemplate.xaml", UriKind.Absolute)
            };
            ConnectorGeometryStyle = resourceDictionary["NormalLine"] as Style;
        }
    }
    ...
    public class CustomLabel : AnnotationEditorViewModel
    {
        ...
        public CustomLabel()
        {
            ...
            ViewTemplate = resourceDictionary["vtemplate"] as DataTemplate;
            EditTemplate = resourceDictionary["etempalte"] as DataTemplate;
        }
    ...
    public class CNode : Node
    {
        ...
        void CNode_ManipulationStarted(object sender, ManipulationStartedRoutedEventArgs e)
        {
        ...
        public static readonly DependencyProperty FromProperty =
            DependencyProperty.Register("From", typeof (double), typeof (CNode), new PropertyMetadata(null, OnChanged));
