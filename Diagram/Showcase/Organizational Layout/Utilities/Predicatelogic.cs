...
namespace OrganizationalChartDemo
{
    ...
    class TextBoxCommand
    {
        ...
        static void textBox_TextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            if (textBox != null)
            {
                textBox.Foreground=new SolidColorBrush(Color.FromArgb(0x33,0x33,0x33,0));
    ...
    class PathCommand
    {
        ...
        static void p_Tapped(object sender, Windows.UI.Xaml.Input.TappedRoutedEventArgs e)
        {
    ...
    class ButtonCommand
    {
        ...
        static void button_Tapped(object sender, Windows.UI.Xaml.Input.TappedRoutedEventArgs e)
        {
