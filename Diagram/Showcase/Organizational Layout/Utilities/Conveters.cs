...
namespace OrganizationalChartDemo
{
  ...
  public class ItemtoImageConverter : IValueConverter
  {
      ...
      public object ConvertBack(object value, Type targetType, object parameter, string language)
      {
          ...
          {
              return "ms-appx:///Diagram/Syncfusion.SampleBrowser.UWP.Diagram/OrganizationalChartDemo/Resource/female.png";
          }
          else
          {
              return "ms-appx:///Diagram/Syncfusion.SampleBrowser.UWP.Diagram/OrganizationalChartDemo/Resource/male.png";
          }
