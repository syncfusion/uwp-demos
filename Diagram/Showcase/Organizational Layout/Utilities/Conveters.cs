...
namespace OrganizationalChartDemo
{
  ...
  public class ItemtoImageConverter : IValueConverter
  {
      ...
      public object ConvertBack(object value, Type targetType, object parameter, string language)
      {
          ...
          {
              return "ms-appx:///Syncfusion.SampleBrowser.UWP.Diagram/Diagram/OrganizationalChartDemo/Resource/female.png";
          }
          else
          {
              return "ms-appx:///Syncfusion.SampleBrowser.UWP.Diagram/Diagram/OrganizationalChartDemo/Resource/male.png";
          }
