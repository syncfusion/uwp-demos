        ...
        private void OnTypeChanged()
        {
            switch (Type)
            {
                case ConnectType.Bezier:
                    Segments = new ObservableCollection<object> {new CubicCurveSegment()};
                    break;
                case ConnectType.Orthogonal:
                    Segments = new ObservableCollection<object> { new OrthogonalSegment() };
                    break;
