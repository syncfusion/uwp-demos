        ...
        void ItemSelectedEvent(object sender, DiagramEventArgs args)
        {
            ...
            if (SelectedItems.Count == 1)
            {
                if (item != null)
                {
                    ...
                    this.Label = (item.Annotations as List<IAnnotation>).FirstOrDefault().Content.ToString();
        ...
        public string Label
        {
            ...
            set
            {
                if (_mLabel != value)
                {
                    ...
                    {
                        IAnnotation annotation = (node.Annotations as List<IAnnotation>).FirstOrDefault();
