...
namespace UMLDiagramDesigner
{
    public partial class AppBarView : UserControl
    {
        ...
        private void AddClass_Clicked(object sender, PointerRoutedEventArgs e)
        {
        ...
        private void AddInterface_Clicked(object sender, PointerRoutedEventArgs e)
        {
            if (AddINodeType != null)
            {
        ...
        private void AddNote_Clicked(object sender, PointerRoutedEventArgs e)
        {
            if (AddINodeType != null)
            {
        ...
        private void AddText_Clicked(object sender, PointerRoutedEventArgs e)
        {
            if (AddINodeType != null)
            {
        ...
        private void Undo_Clicked(object sender, PointerRoutedEventArgs e)
        {
            if (Undo != null)
            {
                Undo.Execute(null);
        ...
        private void Redo_Clicked(object sender, PointerRoutedEventArgs e)
        {
            if (Redo != null)
            {
                Redo.Execute(null);
