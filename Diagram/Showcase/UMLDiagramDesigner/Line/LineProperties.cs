...
namespace UMLDiagramDesigner
{
    public class LineProperties : INotifyPropertyChanged, ILine
    {
        ...
        {
            PathStyle style = new PathStyle();
            this.SourceShape = Shapes.Composition.ToGeometry();
            //style.Data = "M50,0 L100,50 L50,100 L0,50 z";
            style.Fill = Color;
            style.Stroke = Color;
            style.StrokeThickness = 1;
        ...
        {
            PathStyle style = new PathStyle();
            this.TargetShape = Shapes.UniDirectional.ToGeometry();
        ...
        private PathStyle DotedStyle()
        {
            ...
            style.Stroke = Color;
            style.StrokeThickness = 1;
            style.StrokeDashArray = "5, 5";//new DoubleCollection() { 5, 5 };
            return style;
        }
        ...
        {
            PathStyle style = new PathStyle();
            this.TargetShape = Shapes.Inherit.ToGeometry();
        ...
        private Geometry m_TargetShape = Shapes.Star.ToGeometry();
