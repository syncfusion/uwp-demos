...
namespace WorkFlowEditor
{
    ...
    public sealed partial class ProcessAutomationDiagram : Page
    {
        ...
        public ProcessAutomationDiagram()
        {
            ...
            (sfdiagram.SelectedItems as CustomSelector).Commands = new QuickCommandCollection();
            ...
            AddQuickCommand(1, 0.5, new Thickness(50, 0, 0, 0), "M5.9442482,39.851C9.2254944,39.851 11.887001,42.515145 11.887001,45.7964 11.887001,49.077756 9.2254944,51.738001 5.9442482,51.738001 2.6602631,51.738001 0,49.077756 0,45.7964 0,42.515145 2.6602631,39.851 5.9442482,39.851z M54.571699,39.574002C59.779954,39.574002 64,43.792891 64,49.000002 64,54.207113 59.779954,58.426003 54.571699,58.426003 49.365844,58.426003 45.146999,54.207113 45.146999,49.000002 45.146999,43.792891 49.365844,39.574002 54.571699,39.574002z M17.059084,38.473003L17.907999,39.9143 13.223015,42.668002 12.374001,41.226706z M36.32003,38.019001L44.646997,42.765482 43.087067,45.504003 34.763999,40.757521z M26.5662,26.613002C31.077789,26.613002 34.738,30.273369 34.738,34.789052 34.738,39.300835 31.077789,42.961002 26.5662,42.961002 22.05341,42.961002 18.391998,39.300835 18.391998,34.789052 18.391998,30.273369 22.05341,26.613002 26.5662,26.613002z M25.125999,18.207001L28.005999,18.207001 28.005999,25.313002 25.125999,25.313002z M26.5662,0C31.077789,0 34.738,3.6602287 34.738,8.1759319 34.738,12.687735 31.077789,16.348001 26.5662,16.348001 22.05341,16.348001 18.391998,12.687735 18.391998,8.1759319 18.391998,3.6602287 22.05341,0 26.5662,0z",
                ...
                GetQuickCommandShapeStyle()
                );
            QuickCommandViewModel qc = AddQuickCommand(0.5, 0, new Thickness(0, -50, 0, 0), null,
                null, null, null, "F1M23.467,11.733C23.467,18.213 18.214,23.466 11.734,23.466 5.253,23.466 0,18.213 0,11.733 0,5.253 5.253,0 11.734,0 18.214,0 23.467,5.253 23.467,11.733",
                null
                );
            qc.ContentTemplate = this.Resources["editQuickCommand"] as DataTemplate;
        }

        private QuickCommandViewModel AddQuickCommand(double x, double y, Thickness margin, string content, 
            ICommand command, ICommand dragCommand,object parameter, string shape, Style shapeStyle
            )
        {
            ...
            ((sfdiagram.SelectedItems as CustomSelector).Commands as QuickCommandCollection).Add(quickCommand);
            return quickCommand;
        }
         ...
         void sfdiagram_Tapped(object sender, TappedRoutedEventArgs e)
        {
            ...
            //{
                ...
                foreach (var elements in VisualTreeHelper.FindElementsInHostCoordinates(e.GetPosition(null), null))
                {
                    ...
                    else if (elements is PropertyEditor || elements is QuickCommand)
                    {
