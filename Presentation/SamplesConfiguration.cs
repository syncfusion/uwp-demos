...
namespace Syncfusion.SampleBrowser.UWP.Presentation
{
    ...
    public class SamplesConfiguration
    {
        public SamplesConfiguration()
        {
            ...
            SampleHelper.SampleViews.Add(new SampleInfo()
            {
                Header = "PPTX To Markdown",
                Tag = Tags.New,
                Product = "Presentation",
                Category = Categories.FileFormat,
                SampleCategory = "Conversion",
                SearchKeys = new string[] { "Presentation", "PowerPoint", "PPTX", "Markdown" },
                SampleView = typeof(EssentialPresentation.PPTXToMarkdownPresentation).AssemblyQualifiedName,
            });
            SampleHelper.SampleViews.Add(new SampleInfo()
            {
                Header = "Markdown To PPTX",
                Tag = Tags.New,
                Product = "Presentation",
                Category = Categories.FileFormat,
                SampleCategory = "Conversion",
                SearchKeys = new string[] { "Presentation", "PowerPoint", "Markdown", "PPTX" },
                SampleView = typeof(EssentialPresentation.MarkdownToPPTXPresentation).AssemblyQualifiedName,
            });

#if !STORE_SB
            bool isIndividualSample = (Application.Current is App) ? (Application.Current as App).IsIndividualSample() : false;
            string imagePath = isIndividualSample ? "ms-appx:///" : "ms-appx:///Syncfusion.SampleBrowser.UWP.Presentation/";
            SampleHelper.SampleViews.Add(new SampleInfo()
            {
                Header = "Presentation Viewer",
                SampleType = SampleType.Showcase,
                DesktopImage = imagePath + "Presentation/Assets/PresentationViewer_Desktop.jpg",
                MobileImage = imagePath + "Presentation/Assets/PresentationViewer_Mobile.jpg",
