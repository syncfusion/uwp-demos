...
namespace EssentialPresentation
{
    ...
    /// </summary>
    public sealed partial class PPTXToMarkdownPresentation : SampleLayout
    {
        #region fields
        ...
        #region Constructor
        public PPTXToMarkdownPresentation()
        {
        ...
        private async void Convert_BtnClick(System.Object sender, RoutedEventArgs e)
        {
            ...
            {
                Assembly assembly = typeof(PPTXToMarkdownPresentation).GetTypeInfo().Assembly;
                string resourcePath = "Syncfusion.SampleBrowser.UWP.Presentation.Presentation.Assets.PPTXToMarkdown.pptx";
        ...
        private async void Save(IPresentation presentation)
        {
            ...
            if (!(Windows.Foundation.Metadata.ApiInformation.IsTypePresent("Windows.Phone.UI.Input.HardwareButtons")))
            {
                ...
                savePicker.SuggestedFileName = "PPTXToMarkdown";
            ...
            else
            {
                ...
                stgFile = await local.CreateFileAsync("PPTXToMarkdown.md", CreationCollisionOption.ReplaceExisting);
            }
            if (stgFile != null)
            {
                // Save directly to the StorageFile using a FileStream
                Stream fileStream = await stgFile.OpenStreamForWriteAsync();
                fileStream.SetLength(0);
                presentation.Save(fileStream, FormatType.Markdown);
                presentation.Close();
            ...
            inputFilePath.Text = "PPTXToMarkdown.pptx";
        }
        #endregion
    }
}
