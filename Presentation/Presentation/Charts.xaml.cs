...
namespace EssentialPresentation
{
    ...
    /// </summary>
    public sealed partial class ChartsPresentation : SampleLayout
    {
        #region Fields
        ...
        {
            Assembly assembly = typeof(ChartsPresentation).GetTypeInfo().Assembly;
            string resourcePath = "Syncfusion.SampleBrowser.UWP.Presentation.Presentation.Assets.NewCharts.pptx";
