    ...
    public class SamplesConfiguration
    {
        public SamplesConfiguration()
        {
            ...
            SampleHelper.SampleViews.Add(new SampleInfo()
            {
                ...
                DesktopImage = PathHelper.GetResourcePath("WhatsNewImages/Filtering.png"),
                MobileImage = PathHelper.GetResourcePath("WhatsNewImages/Filtering.png"),
            ...
            SampleHelper.SampleViews.Add(new SampleInfo()
            {
                ...
                DesktopImage = PathHelper.GetResourcePath("WhatsNewImages/Stacked Header.png"),
                MobileImage = PathHelper.GetResourcePath("WhatsNewImages/Stacked Header.png"),
