...
namespace Syncfusion.SampleBrowser.UWP.SfTreeGrid
{
    ...
    public static class PathHelper
    {
        ...
        /// </summary>
        /// <param name="relativePath">Relative resource path (e.g., "WhatsNewImages/Filtering.png")</param>
        ...
        public static string GetResourcePath(string relativePath)
        {
            ...
            if (assemblyName == "Syncfusion.SampleBrowser.UWP")
            {
                ...
                return $"ms-appx:///Syncfusion.SampleBrowser.UWP.SfTreeGrid/{relativePath}";
            }
            else
            {
