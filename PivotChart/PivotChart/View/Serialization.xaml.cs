...
namespace BI.PivotChart
{
    ...
    public sealed partial class Serialization : SampleLayout
    {
        ...
        public sealed override void Dispose()
        {
            pivotChart1?.Dispose();
            pivotChart1 = null;
            if (this.btnSerialize != null)
                this.btnSerialize.Click -= this.btnSerialize_Click;
            this.btnSerialize = null;
            if (this.btnDeSerialize != null)
                this.btnDeSerialize.Click -= this.btnDeSerialize_Click;
            this.btnDeSerialize = null;
            base.Dispose();
        }
        ...
        {
            this.pivotChart1.Serialize();
        }

        private void btnDeSerialize_Click(object sender, RoutedEventArgs e)
        {
            this.pivotChart1.Deserialize();
        }
