...
namespace Invoice
{
    ...
    public sealed partial class Address : Page,IDisposable
    {
        ...
        {
            // Load ResourceDictionary conditionally based on OutputType/Configuration
        ...
        /// <summary>
        /// Loads different ResourceDictionaries based on project output type
        /// For Library: uses relative path without assembly prefix
        /// For AppContainerExe: uses full assembly-qualified path
        /// </summary>
        private void LoadConditionalResources()
        {
            var dict = new ResourceDictionary();
#if LIBRARY_OUTPUT
            // For Library output type - use assembly-qualified path
            dict.Source = new Uri("ms-appx:///Syncfusion.SampleBrowser.UWP.DocIO/DocIO/Invoice/Common/IOStandardStyles.xaml", UriKind.Absolute);
#else
            // For AppContainerExe output type - use relative path
            dict.Source = new Uri("ms-appx:///DocIO/Invoice/Common/IOStandardStyles.xaml", UriKind.Absolute);
#endif
