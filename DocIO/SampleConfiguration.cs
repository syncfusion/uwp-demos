...
namespace Syncfusion.SampleBrowser.UWP.DocIO
{
    ...
    public class SamplesConfiguration
    {
        ...
        public SamplesConfiguration()
        {
            ...
            string imagePath = isIndividualSample ? "ms-appx:///" : "ms-appx:///Syncfusion.SampleBrowser.UWP.DocIO/";
            SampleHelper.SampleViews.Add(new SampleInfo()
            {
                ...
                DesktopImage = imagePath + "DocIO/Invoice/Assets/invoice.png",
                MobileImage = imagePath + "DocIO/Invoice/Assets/invoice.png",
			...
			SampleHelper.SampleViews.Add(new SampleInfo()
            {
                SampleView = typeof(EssentialDocIO.CreateInkDemo).AssemblyQualifiedName,
                Header = "Create Ink",
                Category = Categories.FileFormat,
                SampleCategory = "Ink",
                Product = "DocIO",
                SearchKeys = new string[] { "Ink", "CreateInk" },
                Tag = Tags.None
            });
            SampleHelper.SampleViews.Add(new SampleInfo()
            {
                SampleView = typeof(EssentialDocIO.EditInkDemo).AssemblyQualifiedName,
                Header = "Edit Ink",
                Category = Categories.FileFormat,
                SampleCategory = "Ink",
                Product = "DocIO",
                SearchKeys = new string[] { "Ink", "EditInk" },
                Tag = Tags.None
            });
            SampleHelper.SampleViews.Add(new SampleInfo()
            {
