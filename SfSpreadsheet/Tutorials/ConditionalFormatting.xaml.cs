...
namespace SpreadsheetSamples
{
    ...
    public sealed partial class ConditionalFormatting : SampleLayout, IDisposable
    {
        ...
        {
            var assembly = typeof(ConditionalFormatting).GetTypeInfo().Assembly;
            string resourcePath = "Syncfusion.SampleBrowser.UWP.SfSpreadsheet.Assets.ConditionalFormatting.xlsx";
            try
            {
