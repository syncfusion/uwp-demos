    ...
    public sealed partial class TileView : SampleLayout
    {
        public TileView()
        {
            ...
            if (!Windows.Foundation.Metadata.ApiInformation.IsTypePresent("Windows.Phone.UI.Input.HardwareButtons"))
                dic.Source = new Uri("ms-appx:///Syncfusion.SampleBrowser.UWP.Layout/TileView/View/Template_Winrt.xaml", UriKind.RelativeOrAbsolute);
            else
                dic.Source = new Uri("ms-appx:///Syncfusion.SampleBrowser.UWP.Layout/TileView/View/Template_WP.xaml", UriKind.RelativeOrAbsolute);
