    ...
    public class SamplesConfiguration
    {
        public SamplesConfiguration()
        {
            SampleHelper.SampleViews.Add(new SampleInfo()
            {
                ...
                MobileImage = "ms-appx:///Syncfusion.SampleBrowser.UWP.Layout/WhatsNewImage/dockingmanagermobile.png",
                DesktopImage = "ms-appx:///Syncfusion.SampleBrowser.UWP.Layout/WhatsNewImage/dockingmanager.png",                                
