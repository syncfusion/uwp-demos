...
namespace SfRibbon.Ribbon
{
    ...
    public sealed partial class CustomBackStagePage : Page
    {
        public CustomBackStagePage()
        {
            ...
            Images.Add(new People("Carl", "ms-appx:///Syncfusion.SampleBrowser.UWP.Layout/Ribbon/Assets/4.jpg"));
            Images.Add(new People("James", "ms-appx:///Syncfusion.SampleBrowser.UWP.Layout/Ribbon/Assets/1.jpg"));
            Images.Add(new People("Peaches", "ms-appx:///Syncfusion.SampleBrowser.UWP.Layout/Ribbon/Assets/2.jpg"));
            Images.Add(new People("Linda", "ms-appx:///Syncfusion.SampleBrowser.UWP.Layout/Ribbon/Assets/3.jpg"));
            Images.Add(new People("Niko", "ms-appx:///Syncfusion.SampleBrowser.UWP.Layout/Ribbon/Assets/5.jpg"));
