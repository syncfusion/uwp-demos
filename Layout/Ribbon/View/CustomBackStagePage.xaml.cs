...
namespace SfRibbon.Ribbon
{
    ...
    {
        public FontFamily CustomBackMenuIcon {  get; set; }
        ...
        public CustomBackStagePage()
        {
            ...
            CustomBackMenuIcon = new FontFamily(PathHelper.GetResourcePath("Ribbon/FontIcons/CustomBackMenu.ttf#CustomBackMenu"));
            Images = new ObservableCollection<People>();
            Images.Add(new People("Carl", PathHelper.GetResourcePath("Ribbon/Assets/4.jpg")));
            Images.Add(new People("James", PathHelper.GetResourcePath("Ribbon/Assets/1.jpg")));
            Images.Add(new People("Peaches", PathHelper.GetResourcePath("Ribbon/Assets/2.jpg")));
            Images.Add(new People("Linda", PathHelper.GetResourcePath("Ribbon/Assets/3.jpg")));
            Images.Add(new People("Niko", PathHelper.GetResourcePath("Ribbon/Assets/5.jpg")));
