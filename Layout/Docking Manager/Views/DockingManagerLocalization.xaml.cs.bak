    ...
    public sealed partial class DockingManagerLocalization:SampleLayout
    {
        ...
        private void DocumentContainer_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (docking.DocumentContainer.SelectedItem != null && (docking.DocumentContainer.SelectedItem as DocumentTabItem).Header.ToString() == "Pékin")
            {
                ...
                WeatherReport("ms-appx:///Syncfusion.SampleBrowser.UWP.Layout/Docking Manager/Assets/showerClear.png", "ms-appx:///Syncfusion.SampleBrowser.UWP.Layout/Docking Manager/Assets/Showers Late.jpg");
            }
            else if (docking.DocumentContainer.SelectedItem != null && (docking.DocumentContainer.SelectedItem as DocumentTabItem).Header.ToString() == "Madagascar")
            {
                ...
                WeatherReport("ms-appx:///Syncfusion.SampleBrowser.UWP.Layout/Docking Manager/Assets/Rain.png", "ms-appx:///Syncfusion.SampleBrowser.UWP.Layout/Docking Manager/Assets/rainy1.png");
            }
            else if (docking.DocumentContainer.SelectedItem != null && (docking.DocumentContainer.SelectedItem as DocumentTabItem).Header.ToString() == "New York")
            {
                ...
                WeatherReport("ms-appx:///Syncfusion.SampleBrowser.UWP.Layout/Docking Manager/Assets/Mostly Cloudy.png", "ms-appx:///Syncfusion.SampleBrowser.UWP.Layout/Docking Manager/Assets/Partly Cloudy.png");
            }
            else if (docking.DocumentContainer.SelectedItem != null && (docking.DocumentContainer.SelectedItem as DocumentTabItem).Header.ToString() == "Londres")
            {
                ...
                WeatherReport("ms-appx:///Syncfusion.SampleBrowser.UWP.Layout/Docking Manager/Assets/Scattered Thunderstorms.png", "ms-appx:///Syncfusion.SampleBrowser.UWP.Layout/Docking Manager/Assets/Thunderstorms.png");
            }
            ...
            else if (docking.DocumentContainer.SelectedItem != null && (docking.DocumentContainer.SelectedItem as DocumentTabItem).Header.ToString() == "Chennai")
            {
                ...
                TemperatureToNight.Text = "23";
                TemperatureTomoNight.Text = "24";
                WeatherReport("ms-appx:///Syncfusion.SampleBrowser.UWP.Layout/Docking Manager/Assets/showerClear.png", "ms-appx:///Syncfusion.SampleBrowser.UWP.Layout/Docking Manager/Assets/rainy1.png");
            }
        }
