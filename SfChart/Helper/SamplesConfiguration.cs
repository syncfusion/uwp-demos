...
namespace Syncfusion.SampleBrowser.UWP.SfChart
{
    public class SamplesConfiguration
    {
        public SamplesConfiguration()
        {
            ...
            SampleHelper.SampleViews.Add(new SampleInfo()
            {
                SampleView = typeof(FunnelAndPyramidChart).AssemblyQualifiedName,
                Category = Categories.DataVisualization,
                Product = "Chart",
                Header = "Funnel And Pyramid Charts",
                SampleCategory = "Charts",
                Tag = Tags.None,
                HasOptions = false
            });
            SampleHelper.SampleViews.Add(new SampleInfo()
            {
                SampleView = typeof(PolarAndRadarCharts).AssemblyQualifiedName,
                Category = Categories.DataVisualization,
                Product = "Chart",
                Header = "Polar And Radar Charts",
                SampleCategory = "Charts",
                Tag = Tags.None,
                HasOptions = false
            });
            ...
            SampleHelper.SampleViews.Add(new SampleInfo()
            {
                SampleView = typeof(LogarithmicAxisDemo).AssemblyQualifiedName,
                Category = Categories.DataVisualization,
                Product = "Chart",
