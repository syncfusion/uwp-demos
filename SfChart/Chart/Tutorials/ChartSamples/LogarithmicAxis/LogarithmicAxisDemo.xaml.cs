...
namespace Syncfusion.SampleBrowser.UWP.SfChart
{
    public sealed partial class LogarithmicAxisDemo : SampleLayout
    {
        public LogarithmicAxisDemo()
        {
            ...
            SeriesAdornmentsInfo.SymbolWidth = 10;
            SeriesAdornmentsInfo.SymbolHeight = 10;
            SeriesAdornmentsInfo.SymbolInterior = new SolidColorBrush(Colors.White);
            SeriesAdornmentsInfo.SymbolStroke = new SolidColorBrush(Color.FromArgb(0xFF,0x1B,0xA1,0xE2));           
        }
