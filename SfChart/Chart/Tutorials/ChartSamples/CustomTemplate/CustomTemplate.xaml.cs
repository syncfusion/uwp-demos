    ...
    public sealed partial class CustomTemplate : SampleLayout
    {
        ...
        private void OnChartTypeSelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            if (comboBox.SelectedIndex == 0 && viewModelColumn != null && viewModelColumn1 != null)
            {
                ...
                Basic_Chart5.Header = "Literacy rate in Nation";
                Basic_Chart51.Header = "Economic Growth - Year 2014";
                ...
                series3.Interior = new SolidColorBrush(Color.FromArgb(0xFF, 0xEC, 0xF8, 0x75));
                ...
                series1.Interior = new SolidColorBrush(Color.FromArgb(0xFF, 0x99, 0xDE, 0x4A));
