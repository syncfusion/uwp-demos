        ...
        private void OnChartTypeSelectionChanged1(object sender, SelectionChangedEventArgs e)
        {
            ...
            if (comboBox.SelectedIndex == 0 && viewModel != null)
            {
                if (Accumulation_charts != null)
                {
                    ...
                    series1.ColorModel = MainGrid.Resources["customBrush"] as ChartColorModel;
            ...
            if (comboBox.SelectedIndex == 1 && viewModel != null)
            {
                ...
                color1.CustomBrushes.Add(new SolidColorBrush(Color.FromArgb(0xFF, 0x99, 0xDE, 0x4A)));
                color1.CustomBrushes.Add(new SolidColorBrush(Color.FromArgb(0xFF, 0xA4, 0xC5, 0xF4)));
                color1.CustomBrushes.Add(new SolidColorBrush(Color.FromArgb(0xFF, 0xF7, 0x83, 0xC1)));

                color2.CustomBrushes.Add(new SolidColorBrush(Color.FromArgb(0xFF, 0x99, 0xDE, 0x4A)));
                color2.CustomBrushes.Add(new SolidColorBrush(Color.FromArgb(0xFF, 0x99, 0xDE, 0x4A)));
                color2.CustomBrushes.Add(new SolidColorBrush(Color.FromArgb(0xFF, 0xA4, 0xC5, 0xF4)));
                color2.CustomBrushes.Add(new SolidColorBrush(Color.FromArgb(0xFF, 0xA4, 0xC5, 0xF4)));
                color2.CustomBrushes.Add(new SolidColorBrush(Color.FromArgb(0xFF, 0xF7, 0x83, 0xC1)));
                color2.CustomBrushes.Add(new SolidColorBrush(Color.FromArgb(0xFF, 0xF7, 0x83, 0xC1)));

                color3.CustomBrushes.Add(new SolidColorBrush(Color.FromArgb(0xFF, 0x99, 0xDE, 0x4A)));
                color3.CustomBrushes.Add(new SolidColorBrush(Color.FromArgb(0xFF, 0x99, 0xDE, 0x4A)));
                color3.CustomBrushes.Add(new SolidColorBrush(Color.FromArgb(0xFF, 0x99, 0xDE, 0x4A)));
                color3.CustomBrushes.Add(new SolidColorBrush(Color.FromArgb(0xFF, 0x99, 0xDE, 0x4A)));
                color3.CustomBrushes.Add(new SolidColorBrush(Color.FromArgb(0xFF, 0xA4, 0xC5, 0xF4)));
                color3.CustomBrushes.Add(new SolidColorBrush(Color.FromArgb(0xFF, 0xA4, 0xC5, 0xF4)));
                color3.CustomBrushes.Add(new SolidColorBrush(Color.FromArgb(0xFF, 0xA4, 0xC5, 0xF4)));
                color3.CustomBrushes.Add(new SolidColorBrush(Color.FromArgb(0xFF, 0xA4, 0xC5, 0xF4)));
                color3.CustomBrushes.Add(new SolidColorBrush(Color.FromArgb(0xFF, 0xF7, 0x83, 0xC1)));
                color3.CustomBrushes.Add(new SolidColorBrush(Color.FromArgb(0xFF, 0xF7, 0x83, 0xC1)));
                color3.CustomBrushes.Add(new SolidColorBrush(Color.FromArgb(0xFF, 0xF7, 0x83, 0xC1)));
                color3.CustomBrushes.Add(new SolidColorBrush(Color.FromArgb(0xFF, 0xF7, 0x83, 0xC1)));
