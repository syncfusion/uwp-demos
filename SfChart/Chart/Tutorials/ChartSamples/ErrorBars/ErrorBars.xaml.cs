    ...
    public sealed partial class ErrorBars : SampleLayout
    {
        ...
        private void OnVerticalTextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            if (sfchart == null || string.IsNullOrEmpty(text.Text) || !double.TryParse(text.Text, out value))
                return;
            (sfchart.Series[0] as ErrorBarSeries).VerticalErrorValue = Convert.ToDouble(text.Text);
        }
        ...
        private void OnHorizontalTextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            if (sfchart == null || string.IsNullOrEmpty(text.Text) || !double.TryParse(text.Text, out value))
                return;
            (sfchart.Series[0] as ErrorBarSeries).HorizontalErrorValue = Convert.ToDouble(text.Text);
        }
        ...
        private void OnTypeSelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            if (sfchart != null)
                if (combo != null)
                    ...
                    {
                        case 0:
                            (sfchart.Series[0] as ErrorBarSeries).Type = ErrorBarType.Fixed;
                            break;
                        case 1:
                            (sfchart.Series[0] as ErrorBarSeries).Type = ErrorBarType.Percentage;
                            break;
                        case 2:
                            (sfchart.Series[0] as ErrorBarSeries).Type = ErrorBarType.StandardDeviation;
                            break;
                        case 3:
                            (sfchart.Series[0] as ErrorBarSeries).Type = ErrorBarType.StandardErrors;
                            break;
                        default:
                            (sfchart.Series[0] as ErrorBarSeries).Type = ErrorBarType.Custom;
                            break;
                    }
        }
        ...
        private void OnModeSelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            {
                case 0:
                    (sfchart.Series[0] as ErrorBarSeries).Mode = ErrorBarMode.Horizontal;
                    break;
                case 1:
                    (sfchart.Series[0] as ErrorBarSeries).Mode = ErrorBarMode.Vertical;
                    break;
                default:
                    (sfchart.Series[0] as ErrorBarSeries).Mode = ErrorBarMode.Both;
                    break;
            }
        }
