...
# Setting column name 
colnames(ozone) <- c("Month","Day_of_month","Day_of_week","average_ozone_reading","pressure_height","Wind_speed","Humidity","Temperature_at_Sandburg","Temperature_at_El_Monte","Inversion_base_height","Pressure_gradient","Inversion_base_temperature","Visibility")
...
ozone_SVM<-ksvm(average_ozone_reading~.,data=trainData,kernel="rbfdot")
ozone_SVM
...
# Load Original "ozone" dataset from "mlbench" package
data(Ozone)
# Omit rows with missing values
ozoneOriginal = na.omit(Ozone)

# Setting column name 
colnames(ozoneOriginal) <- c("Month","Day_of_month","Day_of_week","average_ozone_reading","pressure_height","Wind_speed","Humidity","Temperature_at_Sandburg","Temperature_at_El_Monte","Inversion_base_height","Pressure_gradient","Inversion_base_temperature","Visibility")
