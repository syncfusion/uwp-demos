...
# Load Original "iris" dataset from "datasets" package
data(iris)
# Omit rows with missing values
irisOriginal = na.omit(iris)

# Replacing column names 
colnames(irisOriginal) <- c("Sepal_Length","Sepal_Width","Petal_Length","Petal_Width","Species")
