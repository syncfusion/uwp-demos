...
namespace SampleBrowser.UWP.PredictiveAnalytics
{
    ...
    public sealed partial class SupportVectorMachine : Page, IDisposable
    {
        ...
        public SupportVectorMachine()
        {
            ...
            //PMML path
            pmmlPath = "ms-appx:///Syncfusion.SampleBrowser.UWP.PredictiveAnalytics/PredictiveAnalytics/Data/Ozone.pmml";
            ...
            if (!Windows.Foundation.Metadata.ApiInformation.IsTypePresent("Windows.Phone.UI.Input.HardwareButtons"))
            {
                ...
                {
                    //resource path
                    string resourcePath = "ms-appx:///Syncfusion.SampleBrowser.UWP.PredictiveAnalytics/PredictiveAnalytics/Getting Started/Support Vector Machine";
                    // input data
