...
namespace SampleBrowser.UWP.PredictiveAnalytics
{
    ...
    public sealed partial class AssociationRules : Page, IDisposable
    {
        ...
        public AssociationRules()
        {
            ...
            //PMML path
            pmmlPath = "ms-appx:///Syncfusion.SampleBrowser.UWP.PredictiveAnalytics/PredictiveAnalytics/Data/Groceries.pmml";
            ...
            if (!Windows.Foundation.Metadata.ApiInformation.IsTypePresent("Windows.Phone.UI.Input.HardwareButtons"))
            {
                ...
                {
                    //resource path
                    string resourcePath = "ms-appx:///Syncfusion.SampleBrowser.UWP.PredictiveAnalytics/PredictiveAnalytics/Getting Started/Association Rules";
                    // input data
