...
namespace SampleBrowser.UWP.PredictiveAnalytics
{
    ...
    public sealed partial class TreeModel : Page, IDisposable
    {
        ...
        public TreeModel()
        {
            ...
            //PMML path
            pmmlPath = "ms-appx:///Syncfusion.SampleBrowser.UWP.PredictiveAnalytics/PredictiveAnalytics/Data/Titanic.pmml";
            ...
            if (!Windows.Foundation.Metadata.ApiInformation.IsTypePresent("Windows.Phone.UI.Input.HardwareButtons"))
            {
                ...
                {
                    //resource path
                    string resourcePath = "ms-appx:///Syncfusion.SampleBrowser.UWP.PredictiveAnalytics/PredictiveAnalytics/Getting Started/Tree Model";
                    // input data
