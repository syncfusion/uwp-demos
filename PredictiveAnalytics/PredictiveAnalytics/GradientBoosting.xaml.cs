...
namespace SampleBrowser.UWP.PredictiveAnalytics
{
    ...
    public sealed partial class GradientBoosting : Page, IDisposable
    {
        ...
        public GradientBoosting()
        {
            ...
            // PMML path
            pmmlPath = "ms-appx:///Syncfusion.SampleBrowser.UWP.PredictiveAnalytics/PredictiveAnalytics/Data/Cars.pmml";
            ...
            if (!Windows.Foundation.Metadata.ApiInformation.IsTypePresent("Windows.Phone.UI.Input.HardwareButtons"))
            {
                ...
                {
                    //resource path
                    string resourcePath = "ms-appx:///Syncfusion.SampleBrowser.UWP.PredictiveAnalytics/PredictiveAnalytics/Getting Started/Gradient Boosting";
                    // input data
