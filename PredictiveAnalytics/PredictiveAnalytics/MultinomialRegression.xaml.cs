...
namespace SampleBrowser.UWP.PredictiveAnalytics
{
    ...
    public sealed partial class MultinomialRegression : Page, IDisposable
    {
        ...
        public MultinomialRegression()
        {
            ...
            // PMML path
            pmmlPath = "ms-appx:///Syncfusion.SampleBrowser.UWP.PredictiveAnalytics/PredictiveAnalytics/Data/Wine.pmml";
            ...
            if (!Windows.Foundation.Metadata.ApiInformation.IsTypePresent("Windows.Phone.UI.Input.HardwareButtons"))
            {
                ...
                {
                    //resource path
                    string resourcePath = "ms-appx:///Syncfusion.SampleBrowser.UWP.PredictiveAnalytics/PredictiveAnalytics/Getting Started/Multinomial Regression";
                    // input data
