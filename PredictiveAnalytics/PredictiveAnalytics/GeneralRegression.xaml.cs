...
namespace SampleBrowser.UWP.PredictiveAnalytics
{
    ...
    public sealed partial class GeneralRegression : Page, IDisposable
    {
        ...
        public GeneralRegression()
        {
            ...
            // PMML path
            pmmlPath = "ms-appx:///Syncfusion.SampleBrowser.UWP.PredictiveAnalytics/PredictiveAnalytics/Data/Audit.pmml";
            ...
            if (!Windows.Foundation.Metadata.ApiInformation.IsTypePresent("Windows.Phone.UI.Input.HardwareButtons"))
            {
                ...
                {                    
                    //resource path
                    string resourcePath = "ms-appx:///Syncfusion.SampleBrowser.UWP.PredictiveAnalytics/PredictiveAnalytics/Getting Started/General Regression";
                    // input data
