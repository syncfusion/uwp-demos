...
namespace SampleBrowser.UWP.PredictiveAnalytics
{
    ...
    public sealed partial class CoxRegression : Page, IDisposable
    {
        ...
        public CoxRegression()
        {
            ...
            // PMML path
            pmmlPath = "ms-appx:///Syncfusion.SampleBrowser.UWP.PredictiveAnalytics/PredictiveAnalytics/Data/Bfeed.pmml";
            ...
            if (!Windows.Foundation.Metadata.ApiInformation.IsTypePresent("Windows.Phone.UI.Input.HardwareButtons"))
            {
                ...
                {
                    //resource path
                    string resourcePath = "ms-appx:///Syncfusion.SampleBrowser.UWP.PredictiveAnalytics/PredictiveAnalytics/Getting Started/Cox Regression";
                    // input data
