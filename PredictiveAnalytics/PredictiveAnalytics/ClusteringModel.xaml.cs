...
namespace SampleBrowser.UWP.PredictiveAnalytics
{
    ...
    public sealed partial class ClusteringModel : Page, IDisposable
    {
        ...
        public ClusteringModel()
        {
            ...
            // PMML path
            pmmlPath = "ms-appx:///Syncfusion.SampleBrowser.UWP.PredictiveAnalytics/PredictiveAnalytics/Data/Glass.pmml";
            ...
            if (!Windows.Foundation.Metadata.ApiInformation.IsTypePresent("Windows.Phone.UI.Input.HardwareButtons"))
            {
                ...
                {
                    //resource path
                    string resourcePath = "ms-appx:///Syncfusion.SampleBrowser.UWP.PredictiveAnalytics/PredictiveAnalytics/Getting Started/Clustering Model";
                    // input data
