...
namespace SampleBrowser.UWP.PredictiveAnalytics
{
    ...
    public sealed partial class RandomForest : Page, IDisposable
    {
        ...
        public RandomForest()
        {
            ...
            //PMML path
            pmmlPath = "ms-appx:///Syncfusion.SampleBrowser.UWP.PredictiveAnalytics/PredictiveAnalytics/Data/Iris.pmml";
            ...
            if (!Windows.Foundation.Metadata.ApiInformation.IsTypePresent("Windows.Phone.UI.Input.HardwareButtons"))
            {
                ...
                {
                    //resource path
                    string resourcePath = "ms-appx:///Syncfusion.SampleBrowser.UWP.PredictiveAnalytics/PredictiveAnalytics/Getting Started/Random Forest";
                    // input data
